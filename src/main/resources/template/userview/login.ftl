                            ...
                            <div class="form-bottom">
			                    <form role="form" action="" method="post" class="login-form">
			                    	<div class="form-group">
			                        	...
			                        	<input type="text" name="form-username" pattern="[0-9]{10}" style="text-align: center;" placeholder="NISN" class="form-username form-control" id="form-username">
			                        </div>
			                        <div class="form-group">
			                        	<label class="sr-only" for="form-password">Kata Sandi</label>
			                        	<input type="password" name="form-password" style="text-align: center;" placeholder="Kata Sandi" class="form-password form-control" id="form-password">
			                        </div>
